...
function pre_install(){
    ...
    read -p "(默认密码是ben123.pw):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="ben123.pw"
    echo
    echo "---------------------------"
    ...
    while true
    do
    echo -e "设置ShadowsocksR远程端口 [1-65535]:"
    read -p "(默认端口: 8080):" shadowsocksport
